/**
 * The field functions of WGSL_FIELD, in JavaScript, for code that cannot run a
 * shader — tests scoring positions, tools reporting on a live world, analysis
 * that needs the resource value at a point without a GPU round trip.
 *
